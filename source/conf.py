...
# pylint: skip-file
#
# Review Graph Mining documentation build configuration file, created by
# sphinx-quickstart on Mon Oct  3 13:30:27 2016.
#
...
# To add GitHub link.
rst_prolog = """
:github_url: https://github.com/rgmining/
"""
...
htmlhelp_basename = 'ReviewGraphMiningdoc'
...
latex_documents = [
    (master_doc, 'ReviewGraphMining.tex', u'Review Graph Mining Documentation',
...
man_pages = [
    (master_doc, 'reviewgraphmining', u'Review Graph Mining Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ReviewGraphMining', u'Review Graph Mining Documentation',
     author, 'ReviewGraphMining', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    "script": ("https://rgmining.github.io/script", None),
